...
IF NOT EXIST build_login_server mkdir build_login_server
...
cl /Fe:login_server_module.dll "..\src\login_server.c"   !FLAGS_COMPILE_D! !DEFINES_D! /LD  /link !FLAGS_LINK_D!                    !LIBS_D!
del .reload-lock

...
set OUTPUT_NAME=zone_server.exe
set SOURCES="..\src\win32_zone_server.c"
...
cl /Fe:zone_server_module.dll "..\src\kotk_zone_server.c"   !FLAGS_COMPILE_D! !DEFINES_D! /LD  /link !FLAGS_LINK_D!                    !LIBS_D!
del .reload-lock

cl /Fe:zone_server.exe        "..\src\win32_zone_server.c" !FLAGS_COMPILE_D! !DEFINES_D! /MTd /link !FLAGS_LINK_D! /subsystem:console !LIBS_D!

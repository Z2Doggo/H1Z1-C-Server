...
gcc -o login_server_module.dll -O1 -g "..\src\h1z1_login_server.c" %FLAGS_COMPILE_D% %DEFINES_D% -shared %FLAGS_LINK_D% %LIBS_D%

echo LOCKED > .reload-lock
del .reload-lock

gcc -o login_server.exe -O1 -g "..\src\win32_login_server.c" %FLAGS_COMPILE_D% %DEFINES_D% %FLAGS_LINK_D% %LIBS_D%
popd

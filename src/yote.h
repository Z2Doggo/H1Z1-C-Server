...
// TODO(rhett): try this
#define DO_ONCE(to_do)  local_persist b32 do_once_##__LINE__ = 0; if (!do_once_##__LINE__++) { to_do; }
...
#define PARAMS_DECLARE(return_type, name, args)  typedef struct name##_params { int _; args; } name##_params; return_type (name)(name##_params params)
